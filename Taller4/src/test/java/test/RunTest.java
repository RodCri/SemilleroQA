...
public class RunTest {
	...
	public void test() throws Exception{
		pages.enterAlerts(properties);
		pagesAlert.enterAlert(properties);
		pagesAlert.protAlert(read,properties,path);
		pagesAlert.secondAlert();
		pagesAlert.timerAlert();
		pagesAlert.confirmAlert();
		pagesAlert.cancelAlert();
	}
